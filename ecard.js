...
function saveContact() {
    const name = 'Zobayar Ahmmad Tawsif';
    const organization = 'Roaming Tours & Travels';
    const title = 'Junior Executive';
    const officePhone = '+8801334547049';
    // const personalPhone = '+8801770388535';
    const email = 'zobayarahmmad2003@gmail.com';
...
function openWhatsApp() {
    const whatsappNumber = '8801334547049';
